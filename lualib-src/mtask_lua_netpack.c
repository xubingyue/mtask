...
/*TCP stream   解析成  len + package  big-endian*/
...
/*userdata queue ;lightuserdata msg , integer  size ; return  1:userdata queue 2:integer type 3: integer fd 4: string msg | lightuserdata/integer*/
static int
lfilter(lua_State *L) {
